Rails.application.routes.draw do
  ...
  get 'best_deals/:category_id/sub_categories/:sub_category_id', to: "best_deals#deal_sub_category", as: 'deal_sub_category'
  ...
  get 'newest_products/:category_id/sub_categories/:sub_category_id', to: "newest_products#newest_sub_category", as: 'newest_sub_category'
